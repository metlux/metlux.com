...
<div class="headertop"> 
  <div class="header-inner">
    ...
    <div class="topright">
         <div class="toggle"><a class="toggleMenu" href="<?php echo esc_url('#');?>" style="display:none;"><?php esc_attr_e('Menu','online-coach'); ?></a></div> 
        <div class="sitenav">
...
<div class="widget-right">
    <ul>
        ...
        <li>
            ...
            <span><?php esc_attr_e('Call us today', 'online-coach');?> <strong><?php echo esc_attr($contact_no); ?></strong></span>
        </li>
        <?php } ?> 
		<?php 
        ...
        <li>
            ...
            <span><?php esc_attr_e('Email us on ', 'online-coach');?> <strong><a href="mailto:<?php echo antispambot( sanitize_email( $contact_mail ) ); ?>"><?php echo antispambot( sanitize_email( $contact_mail ) ); ?></a></strong></span>
        </li>
        <?php } ?>  
    </ul>
</div><!--.widget-right-->
